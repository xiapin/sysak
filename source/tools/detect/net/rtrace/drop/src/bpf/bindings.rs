...
pub const IPTABLE_FILTER: u32 = 1;
pub const IPTABLE_MANGLE: u32 = 2;
pub const IPTABLE_RAW: u32 = 3;
pub const ARPTABLE_FILTER: u32 = 4;
pub const IPTABLE_SECURITY: u32 = 5;
pub const IPTABLE_NAT: u32 = 6;
...
pub const NF_CONNTRACK: _bindgen_ty_3 = 0;
pub const IPTABLES: _bindgen_ty_3 = 1;
pub const KFREE_SKB: _bindgen_ty_3 = 2;
pub const TCP_DROP: _bindgen_ty_3 = 3;
pub const TP_KFREE_SKB: _bindgen_ty_3 = 4;
pub type _bindgen_ty_3 = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct drop_filter {
    pub protocol: u16_,
    pub ap: addr_pair,
}
#[test]
fn bindgen_test_layout_drop_filter() {
    assert_eq!(
        ::std::mem::size_of::<drop_filter>(),
        16usize,
        concat!("Size of: ", stringify!(drop_filter))
    );
    assert_eq!(
        ::std::mem::align_of::<drop_filter>(),
        4usize,
        concat!("Alignment of ", stringify!(drop_filter))
    );
    fn test_field_protocol() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<drop_filter>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).protocol) as usize - ptr as usize
            },
            0usize,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct drop_event {
    pub location: u64_,
    pub proto: u16_,
    pub ap: addr_pair,
}
#[test]
fn bindgen_test_layout_drop_event() {
    assert_eq!(
        ::std::mem::size_of::<drop_event>(),
        24usize,
        concat!("Size of: ", stringify!(drop_event))
    );
    assert_eq!(
        ::std::mem::align_of::<drop_event>(),
        8usize,
        concat!("Alignment of ", stringify!(drop_event))
    );
    fn test_field_location() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<drop_event>::uninit();
                let ptr = uninit.as_ptr();
