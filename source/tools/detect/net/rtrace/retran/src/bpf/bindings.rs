...
pub const SYN_RETRAN: _bindgen_ty_3 = 0;
pub const SLOW_START_RETRAN: _bindgen_ty_3 = 1;
pub const RTO_RETRAN: _bindgen_ty_3 = 2;
pub const FAST_RETRAN: _bindgen_ty_3 = 3;
pub const TLP: _bindgen_ty_3 = 4;
pub type _bindgen_ty_3 = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct retran_event {
    pub tcp_state: u8_,
    pub ca_state: u8_,
    pub retran_type: u8_,
    pub ts: u64_,
...
#[test]
fn bindgen_test_layout_retran_event() {
    assert_eq!(
        ::std::mem::size_of::<retran_event>(),
        32usize,
        concat!("Size of: ", stringify!(retran_event))
    );
    assert_eq!(
        ::std::mem::align_of::<retran_event>(),
        8usize,
        concat!("Alignment of ", stringify!(retran_event))
    );
    fn test_field_tcp_state() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<retran_event>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).tcp_state) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
                stringify!(retran_event),
                "::",
                stringify!(tcp_state)
            )
        );
    }
    test_field_tcp_state();
    fn test_field_ca_state() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<retran_event>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).ca_state) as usize - ptr as usize
            },
            1usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_ca_state();
    fn test_field_retran_type() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<retran_event>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).retran_type) as usize - ptr as usize
            },
            2usize,
            concat!(
                "Offset of field: ",
                stringify!(retran_event),
                "::",
                stringify!(retran_type)
            )
        );
    }
    test_field_retran_type();
    fn test_field_ts() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<retran_event>::uninit();
