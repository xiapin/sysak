...
int main(int argc, char **argv)
{
	...
	argfd = bpf_map__fd(obj->maps.argmap);
	bpfarg.targ_tgid = env.pid;
	bpfarg.targ_pid = env.tid;
	bpfarg.user_threads_only = env.user_threads_only;
	bpfarg.kernel_threads_only = env.kernel_threads_only;
	bpfarg.state = env.state;
	bpfarg.min_block_ns = env.min_block_time;
	bpfarg.max_block_ns = env.max_block_time;
