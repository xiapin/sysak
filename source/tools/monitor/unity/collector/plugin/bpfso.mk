...
COOLBPF_OBJ += $(OBJ_LIB_PATH)/lib/libcoolbpf.so
...
CFLAGS += $(EXTRA_CLFAGS) -g -O2 -Wall -fPIC
LDFLAGS += $(EXTRA_LDFLAGS) -L$(OBJ_LIB_PATH) -L$(COOLBPF_OBJ) -lelf -lz -fPIC -shared
INCLUDES += $(EXTRA_INCLUDES) -I$(OBJPATH) -I$(SRC)/lib/internal/ebpf -I$(TARGET_PATH) -I$(OBJ_LIB_PATH) -I$(SRC)/lib/internal/ebpf/coolbpf/third/libbpf/include/uapi -I$(SRC)/lib/uapi/include -I$(OBJ_LIB_PATH)/include/coolbpf/
...
$(so): $(target_cobjs) $(bpfskel) $(COOLBPF_OBJ)
	$(call msg,BINARY,$@)
	$(Q)$(CC) $(CFLAGS) -shared -Wl,-soname,$(so) $(INCLUDES) $^ -o $(TARGET_PATH)/$@ $(LDFLAGS)
	cp $(TARGET_PATH)/$@ ../../native
$(target_cobjs): $(cobjs)
