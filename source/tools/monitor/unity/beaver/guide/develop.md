...
```
docker run -v /root/1ext/code/:/root/code -v /:/mnt/host:ro --net=host --pid=host --name unity --privileged  -itd registry.cn-hangzhou.aliyuncs.com/sysom/sysom:v5.0 /bin/sh
```
