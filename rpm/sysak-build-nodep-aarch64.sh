...
main() {
	...
	TARGET_LIST="--enable-target-all --disable-target-cgtool --disable-target-schedtrace --disable-target-tcpping --disable-target-pagescan --disable-target-kvmexittime --disable-target-unity --disable-target-ioMonitor --enable-static"
